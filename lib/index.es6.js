...
export { Context, context, createContextHandler, useContext } from './plugins/jsx/context/context.es6.js';
export { slots } from './plugins/jsx/slots/slots.es6.js';
export { getSlots, slot, useSlots } from './plugins/jsx/slot/slot.es6.js';
export { getRoute, getStrongRoute, history, parsedPath, pathDeep, router, routerContext, routes, routesIsh, useRoute } from './plugins/jsx/router/router.es6.js';
...
export { useParent } from './utils/useParent/useParent.es6.js';
