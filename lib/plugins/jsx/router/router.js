...
function router(_a, handler) {
    ...
    var slot$1 = new watchState.Cache(function () {
    ...
    return innet__default["default"](function () {
        var currentSlot = slot$1.value;
        if (currentSlot !== slots['']) {
            return search ? currentSlot : {
                type: function () {
                    innet__default["default"](currentSlot, context.createContextHandler(jsx.useHandler(), routerContext, deep + 1));
                },
            };
        }
        return currentSlot;
