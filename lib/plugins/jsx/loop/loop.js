...
function loop(_a, handler) {
    ...
    if (typeof ofProp === 'function' || typeof sizeProp === 'function') {
        var _f = tslib.__read(useComment.useComment(handler, type), 2), childHandler_1 = _f[0], mainComment_1 = _f[1];
        var map_1 = new Map();
        var keysList_1 = [];
        var isElse_1 = false;
        ...
        new watchState.Watch(function (update) {
            ...
            if (update) {
                ...
                var _loop_1 = function () {
                    ...
                    var keep = keepKeys.includes(valueKey);
                ...
                var _loop_2 = function () {
                    ...
                    var _a = tslib.__read(useComment.useComment(childHandler_1, valueKey, true), 2), deepHandler = _a[0], comment = _a[1];
