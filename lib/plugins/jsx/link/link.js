...
function link(_a, oldHandler) {
    ...
    var getHref = typeof href === 'function' ? href : function () { return href; };
    ...
    var getClass = function () {
        ...
        return function () {
            ...
            return classes__default["default"]([
                styles.root,
                router.history.is("^".concat(prefix).concat(clearHref(href)).concat(exact ? '$' : '')) && styles.active,
            ]);
        };
    };
    ...
    return innet__default["default"]({
        ...
        props: tslib.__assign(tslib.__assign({}, rest), { class: getClass(), href: function () {
                ...
                return href === '/' ? "/".concat(locale) : "/".concat(locale).concat(href);
            }, onclick: handleClick }),
        children: children,
    }, handler);
}
