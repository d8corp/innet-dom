...
export { callFunctionHandler } from './handlers/callFunctionHandler.es6.js';
export { portal } from './plugins/jsx/portal/portal.es6.js';
export { getRoute, getStrongRoute, parsedPath, parsedSearch, pathDeep, router, routerContext, routes, routesIsh, useRoute } from './plugins/jsx/router/router.es6.js';
...
export { callFunction } from './plugins/callFunction/callFunction.es6.js';
